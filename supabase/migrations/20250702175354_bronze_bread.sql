/*
  ...
  2. Security
    ...
    - Add policy for public insert access (for loan application submissions)
...
-- Allow public insert access for loan applications
...
-- Allow users to read their own applications (if authenticated)
